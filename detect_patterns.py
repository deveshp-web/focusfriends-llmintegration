...
def main():
    ...
    out_path = os.path.join(DATA_DIR, "insights.jsonl")
    by_classroom_path = os.path.join(DATA_DIR, "flagged_by_classroom.jsonl")
    meta_path = os.path.join(DATA_DIR, "insights_meta.json")
    judge_path = os.path.join(DATA_DIR, "judge_cases.jsonl")
